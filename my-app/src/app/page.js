  ...
  return (
    <div className='overflow-hidden'>
      <h1 className='text-center mt-10 md:mt-[4rem] lg:mt-[6rem] xl:mt-[3rem] text-3xl md:text-6xl'>welcome<p className='mt-0.5 transform   translate-x-[10%]'>to Dams</p></h1>
           ...
           <Image  className=' mt-10 shadow-2xl transform translate-x-[30%] md:translate-x-[90%] lg:translate-x-[130%] xl:ml-[15rem]'  src="/images/phone.png" alt="dams logo"  width={300} height={400}  />
